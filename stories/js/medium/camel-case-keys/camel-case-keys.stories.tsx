  ...
  return (
    <div style={{ padding: "20px", fontFamily: "monospace" }}>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <p>
          The <code>camelCaseKeys()</code> function converts all object keys
          from snake_case to camelCase. It recursively processes nested objects
          and arrays without modifying the original data.
        </p>
      </section>
...
const meta = {
  title: "JS/medium/camel-case-keys",
  tags: ["!autodocs"],
  component: Demo,
