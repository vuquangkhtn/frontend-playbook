In classnames, we implemented classnames, a commonly-used utility in modern front end applications to conditionally join CSS class names together. However, there are some cases that the library does not do:
