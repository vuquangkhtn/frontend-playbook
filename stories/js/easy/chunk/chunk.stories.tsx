  ...
  return (
    <div style={{ padding: "20px", fontFamily: "monospace" }}>
      ...
      <section style={{ marginBottom: "30px" }}>
        <h3>What is chunk()?</h3>
        <p>
          The <code>chunk()</code> function splits an array into groups of a
          specified size. If the array length is not evenly divisible by the
          chunk size, the last chunk will contain the remaining elements.
        </p>
      </section>
        ...
        >
          ...
          >
            {result.map((chunkData, chunkIdx) => (
              <div
                key={chunkIdx}
                style={{ marginBottom: "15px", gridColumn: `1 / -1` }}
              >
                <p
                  style={{
                    margin: "0 0 8px 0",
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        <ul>
          <li>
            <strong>Pagination:</strong> Split items into pages of 10, 20, 50
            items each
          </li>
          <li>
            <strong>Grid Layout:</strong> Arrange items in a grid with specific
            columns
          </li>
          <li>
            <strong>Batch Processing:</strong> Process data in batches of N
            items
          </li>
          <li>
            <strong>API Requests:</strong> Split large datasets into smaller
            requests
          </li>
          <li>
            <strong>CSV Export:</strong> Organize data into rows with fixed
            columns
          </li>
          <li>
            <strong>Display Optimization:</strong> Show items in groups for
            better performance
          </li>
        </ul>
      </section>
