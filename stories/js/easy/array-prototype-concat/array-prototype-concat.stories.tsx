    ...
    <div style={{ padding: "20px", fontFamily: "monospace" }}>
      ...
      <section style={{ marginBottom: "30px" }}>
                  ...
                  {Array.isArray(item) ? (
                    ...
                    <>
                      ...
                      <input
                        ...
                        value={item}
                        onChange={(e) =>
                          handleUpdateValue(idx, Number(e.target.value))
                        }
                        style={{
                          marginLeft: "10px",
                          padding: "4px",
        ...
        >
          <p>
            ...
            <code>[{baseArr.myConcat(...items).join(", ")}]</code>
          </p>
      ...
      <section style={{ marginBottom: "30px" }}>
        ...
        >
          <Example
            title="Single Array"
            code="[1, 2].myConcat([3, 4])"
            result={[1, 2].myConcat([3, 4])}
          />
          <Example
            title="Multiple Arrays"
            code="[1].myConcat([2], [3])"
            result={[1].myConcat([2], [3])}
          />
          <Example
          ...
          <Example
            ...
            code="[1].myConcat([2], 3, [4])"
            result={[1].myConcat([2], 3, [4])}
          />
          <Example
            title="No Arguments"
            code="[1, 2].myConcat()"
...
const meta = {
  title: "JS/easy/Array.prototype.concat",
  tags: ["!autodocs"],
  component: Demo,
