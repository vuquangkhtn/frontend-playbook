  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'monospace' }}>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <p>
          The <code>square()</code> method creates a new array with each element squared 
          (multiplied by itself). It does not modify the original array.
        </p>
      </section>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <div style={{ marginTop: '15px', padding: '10px', backgroundColor: '#f3e5f5', borderRadius: '4px' }}>
          <p>
          ...
          <p style={{ color: '#666', fontSize: '12px', marginTop: '5px' }}>
            Original array unchanged: {JSON.stringify(arr) === JSON.stringify(arr)}
          </p>
        </div>
      </section>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <ul>
          <li>
            <strong>Distance Calculation:</strong> In math/physics, calculating Euclidean distance: 
            <code style={{ marginLeft: '5px' }}>[3, 4].square().reduce((a,b)={'>'}a+b)</code> = 25 (so √25 = 5)
          </li>
          <li>
            <strong>Data Scaling:</strong> Squaring values to emphasize larger differences
          </li>
          <li>
            <strong>Variance Calculation:</strong> First step in calculating statistical variance
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>✅ Simple, readable alternative to <code>.map(n ={'>'} n * n)</code></li>
        </ul>
      </section>
    </div>
  );
...
const meta = {
  title: 'JS/Array.prototype.square',
  tags: ['!autodocs'],
  component: Demo,
