...
The left edge of the selection box is smaller than the right edge of the grid cell.
The right edge of the selection box is larger the right edge of the grid cell.
The top edge of the selection box is smaller than the bottom edge of the grid cell.
The bottom edge of the selection box is larger than the top edge of the grid cell.
If all of these conditions are true, then the selection box overlaps with the grid cell. This is a great visualization to demonstrate rectangle intersection.
