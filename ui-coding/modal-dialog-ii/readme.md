Note: This is an advanced version of Modal Dialog, you should complete that question first before attempting this question.

A dialog is a window overlaid on either the primary window or another dialog window. Windows under a modal dialog are inert. That is, users cannot interact with content outside an active dialog window. Inert content outside an active dialog is typically visually obscured or dimmed so it is difficult to discern, and in some implementations, attempts to interact with the inert content cause the dialog to close.

Source: Dialog (Modal) Pattern | ARIA Authoring Practices Guide

In Modal Dialog, we built a functional modal dialog component that can be opened and closed with customizable title and contents.
...
Requirements
The ARIA Authoring Practices Guide has a long list of guidelines for the ARIA roles, states, and properties to add to the various elements of a modal dialog component.
...
Notes
The skeleton code uses the solution of Modal Dialog, but you are free to use your own solution as a starting point.
